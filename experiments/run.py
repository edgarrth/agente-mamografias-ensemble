...
if __name__=="__main__":
    ...
    p.add_argument("--configuration-ratio",type=float,default=0.30); p.add_argument("--seed",type=int,default=42); p.add_argument("--run-all-configurations",action="store_true")
